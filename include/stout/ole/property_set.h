...
using property_value = std::variant<std::monostate,       // VT_EMPTY / VT_NULL
...
[[nodiscard]] STOUT_API auto parse_property_set(std::span<const uint8_t> data) -> std::expected<property_set, error>;
