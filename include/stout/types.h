...
namespace stout {
    ...
    [[nodiscard]] constexpr auto error_message(error e) noexcept -> const char * {
        ...
        case error::invalid_version:
            return "invalid compound file version";
        case error::invalid_sector_size:
            return "invalid sector size";
        case error::invalid_header:
            return "invalid compound file header";
        case error::invalid_fat:
            return "invalid FAT structure";
        case error::invalid_difat:
            return "invalid DIFAT structure";
        case error::invalid_directory:
            return "invalid directory entry";
        case error::invalid_mini_fat:
            return "invalid mini FAT structure";
        case error::invalid_stream:
            return "invalid stream";
        case error::invalid_name:
            return "invalid entry name";
        case error::corrupt_file:
            return "corrupt compound file";
